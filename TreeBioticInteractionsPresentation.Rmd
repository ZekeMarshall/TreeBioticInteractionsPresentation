...
* Mitchell et al (2014) - AshEcol: A spreadsheet of Ash-associated biodiversity.
...
```{r species_time_box, echo=FALSE, warning=FALSE, cache=FALSE, message=FALSE}
...
foo_plotly <- plotly::ggplotly(foo,
                               width = 1000,
                               height = 600) |>
  plotly::config(displayModeBar = FALSE)

widgetframe::frameWidget(foo_plotly)
